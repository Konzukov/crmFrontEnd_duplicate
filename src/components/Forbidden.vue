    ...
    <g>
      ...
      <g class="st4">
        ...
        <text transform="matrix(1 0 0 1 85.4612 263.0171)" class="st9 st20 st21">404 error</text>
            ...
            <text transform="matrix(1 0 0 1 47.2058 329.1734)" class="st4"><tspan x="0" y="0" class="st23 st24 st25">Lorem ipsum dolor sit amet, consectetur adipiscing </tspan>
              <tspan x="0.6" y="11.7"
                     class="st23 st24 st25">elit, sed do eiusmod tempor incididunt ut labore et </tspan>
              <tspan x="6.2" y="23.3"
                     class="st23 st24 st25">dolore magna aliqua. Ut enim ad minim veniam.</tspan></text>
            <g class="st4">
    ...
    <g>
      ...
      <path class="st12" d="M259.4,217.4c-1.8,1.9-3.5,3.8-5.3,5.6c-0.6,0.7-1.3,1.3-2,1.9c-1.4,1.3-3,1.2-4.1-0.4
        ...
        <g>
          ...
          <text opacity="0.6" x="15" y="257" fill="#000" font-family="Viga" font-size="25">Не достаточно прав
      <tspan x="35" y="292">Вернитесь назад</tspan>
            <tspan x="100" y="357" fill="#000" font-size="65">403</tspan>
            <tspan x="93" y="381.2" fill="#000" font-size="15">Доступ запрещен</tspan>
    </text>

          <text x="15" y="255" fill="#6BA184" font-family="Viga" font-size="25">Не достаточно прав
      <tspan x="35" y="290"> <router-link :to="{name: 'dashboard'}">Вернитесь назад </router-link></tspan>
            <tspan x="100" y="355" fill="#BF3E73" font-size="65">403</tspan>
            <tspan x="93" y="380" fill="#6BA184" font-size="15">Доступ запрещен</tspan>
    </text>
  </g>
